...
const AboutPage = () => (
    <>
        <BandTitle>Who We Are</BandTitle>
        <Text>
        ...
        <BandTitle>Safety Protocols</BandTitle>
        <Text>
        ...
        <List>
            ...
            <ListItem>
                Wear gloves and a mask or face covering while working.
            </ListItem>
            <ListItem>
                Pause their work if exposed to COVID-19, and resume their
                activity once cleared by a medical professional.
            </ListItem>
